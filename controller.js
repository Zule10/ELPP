...
app.get("/user",function(req,res){
  User.find().exec(function(err,users){
   res.render("User.jade",{users:users,success:req.session.success, errors:req.session.errors});
...
app.get("/account",function(req,res){
  Account.find().populate("ownerUser").populate("ownerPage").exec(function(err,accounts){
    res.render("Account.jade",{accounts:accounts,success:req.session.success1, errors:req.session.errors1});
    req.session.errors1 = null;
    req.session.success1 = null;
  });
});
...
app.get("/page",function(req,res){
  Page.find().exec(function(err,pages){
    res.render("Page.jade",{pages:pages,success:req.session.success2, errors:req.session.errors2});
    req.session.errors2 = null;
    req.session.success2 = null;
  });
});
